import numpy as np
import os
from attacks import SlowModificationAttack, InstantOverrideAttack
from utils import rmse, plot_time_series
...
def run_experiment(reset_interval, attack=None):
    drone = Drone()
    controller = Controller(dt)
    reset_mgr = ResetManager(reset_interval)
